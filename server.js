...
function shouldInitSQLite() {
  ...
  return process.env.NEXT_PUBLIC_STORAGE_TYPE === 'd1' && !isCloudflare && process.env.PURETV_LITE !== 'true';
}
...
const useTurbopack = !edgeRuntime && process.env.PURETV_BUNDLER === 'turbopack';
const app = next({
  dev, hostname, port,
