...
const MobileHeader = ({ showBackButton = false }: MobileHeaderProps) => {
  ...
  return (
    <header
      className='md:hidden fixed top-0 left-0 right-0 z-999 w-full bg-white/70 backdrop-blur-xl border-b border-gray-200/50 shadow-xs dark:bg-gray-900/70 dark:border-gray-700/50'
