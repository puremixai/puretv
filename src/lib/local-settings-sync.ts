...
export const LOCAL_SETTINGS_SYNC_MODE_KEY = 'puretv_local_settings_sync_mode';
export const LOCAL_SETTINGS_SYNC_LAST_PULL_KEY = 'puretv_local_settings_sync_last_pull';
