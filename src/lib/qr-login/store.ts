...
type GlobalWithQr = typeof globalThis & { __pureTvQrLoginStore?: Map<string, QrLoginSession> };

const g = globalThis as GlobalWithQr;
export const qrLoginStore = g.__pureTvQrLoginStore || new Map<string, QrLoginSession>();
g.__pureTvQrLoginStore = qrLoginStore;
