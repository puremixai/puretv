        ...
        {items.map((item) => (
          ...
          >
            <div className='flex gap-4'>
              <div className='h-28 w-20 shrink-0 overflow-hidden rounded-2xl bg-linear-to-br from-emerald-50 to-amber-50 ring-1 ring-emerald-100 dark:from-gray-900 dark:to-emerald-950/20 dark:ring-emerald-500/10'>
                {item.cover ? (
