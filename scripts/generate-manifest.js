...
// 从环境变量获取站点名称
const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'PureTV';
...
const manifestTemplate = {
  ...
  icons: [
    {
      src: '/icons/icon-192x192.png?v=puretv',
      sizes: '192x192',
      type: 'image/png',
    },
    {
      src: '/icons/icon-256x256.png?v=puretv',
      sizes: '256x256',
      type: 'image/png',
    },
    {
      src: '/icons/icon-384x384.png?v=puretv',
      sizes: '384x384',
      type: 'image/png',
    },
    {
      src: '/icons/icon-512x512.png?v=puretv',
      sizes: '512x512',
      type: 'image/png',
    },
  ],
